...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SHIVABA HOTEL,</p>
				<p>DehuRoad,Pune,Road,<br>Pune,<br>India.</p>
				<p>(+91) 72 193 637 31</p>
			</address>
			<span><img alt="" src="assets/img/ssv.png"</span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@shivaba.com || Web :- www.shivaba.com || Phone :- +91 7219363731 </p>
			</div>
		</aside>
	</body>
</html>
